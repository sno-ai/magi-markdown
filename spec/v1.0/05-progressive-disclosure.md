...
- **Why no compiler-side editorial behavior.** The compiler is a structural transform, not an editor. Authors who want stricter checking SHOULD run the linter (`packages/mda` reference implementation; see `packages/mda/IMPL-SPEC.md`).
