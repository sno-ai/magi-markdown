---
title: "Introduction"
description: "MDA: Bridging human content and AI processing with context-rich Markdown."
---
...
Introducing **MDA (Markdown for Agent)**. An _AI-native_, _human-readable_, and _extensible_ Markdown format designed to solve this.
...
MDA extends standard Markdown, keeping it readable while adding optional, structured layers for AI.
...
<CardGroup cols="2">
  ...
  <Card title="Explicit Relationships" icon="link">
    ...
    - Specify types: `parent`, `child`, `citation`, `related`.
  ...
  <Card title="Human & Machine Friendly" icon="circle-check">
    ...
    - MDA-aware processors unlock AI potential.
    - Optional components: Use only what you need.
    </div>
  </Card>
</CardGroup>

Stop fighting content conversion. Focus on building intelligent applications while MDA provides the AI-ready foundation.

## Use Cases

What can you build with MDA?
