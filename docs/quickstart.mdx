...
1. A text editor.
2. The `@mda/cli` reference implementation, or — if you'd rather not install anything — the [create-sign-verify guide](https://github.com/sno-ai/mda/blob/main/docs/create-sign-verify-mda.md), which uses only standard hashing and DSSE-capable signing tools.
