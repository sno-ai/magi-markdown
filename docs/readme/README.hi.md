...
2. **ह्यूमन मोड** — एक मनुष्य `sha256sum` और `cosign` के साथ सीधे `.md` लिखता है।
...
रेफ़रेंस CLI के बिना मैनुअल और एजेंट-लिखित रास्तों के लिए देखें [`docs/manual-workflow.md`](../../docs/manual-workflow.md), और प्राथमिकता तथा मोड के नॉर्मेटिव कथन के लिए देखें [`spec/v1.0/00-overview.md §0.5–§0.6`](../../spec/v1.0/00-overview.md)।
...
JSON Schemas [`schemas/`](../../schemas/) में रहते हैं — `frontmatter-source`, `frontmatter-skill-md`, `frontmatter-agents-md`, `frontmatter-mcp-server-md`, `relationship-footnote`, साथ ही `integrity`, `signature`, `requires`, `depends-on`, और `version-range` के लिए साझा `_defs/`। कन्फ़ॉर्मेंस फ़िक्स्चर और वैलिडेशन रनर [`conformance/`](../../conformance/) में रहते हैं (`node scripts/validate-conformance.mjs`)।
...
**आज क्या काम करता है:** आप एक `.mda` लिख सकते हैं, उसे एक या अधिक कन्फ़ॉर्मेंट `.md` आउटपुट में कंपाइल कर सकते हैं, और उन्हें टार्गेट JSON Schemas तथा 35-फ़िक्स्चर वाले कन्फ़ॉर्मेंस स्यूट के विरुद्ध वैलिडेट कर सकते हैं।

**अभी क्या बनाया जा रहा है:**

- सिग्नेचर के लिए एक बंडल किया हुआ verifier अभी शिप नहीं हुआ है। ऑपरेटर फ़िलहाल `cosign` और एक JCS लाइब्रेरी को ख़ुद जोड़ते हैं।
