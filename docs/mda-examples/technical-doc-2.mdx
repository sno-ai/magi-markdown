...
description: Example document showcasing various footnote relationship types in MDA.
tags:
  - footnote
  - relationships
  - mda-example
...
MDA footnotes enable explicit, structured relationships between documents, enhancing discoverability and context for AI systems.
...
[^core-spec]: `{"rel-type":"citation","doc-id":"c5a6b7d8-1e2f-3a4b-5c6d-7e8f9a0b1c2d","rel-desc":"Core technical specification overview"}`
