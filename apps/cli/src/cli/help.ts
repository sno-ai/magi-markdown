...
Usage:
  ...
  mda llmix trust manifest --registry-dir <dir> --registry-root <file> --release-plan <file> --policy <path> (--expected-root-digest <digest>|--derive-root-digest) [--minimum-revision <rev>] [--minimum-published-at <iso>] [--high-watermark <value>] --out <file> [--did-document <path>] [--offline-sigstore-fixture <path>] [--json]
...
Commands and options:
  ...
  llmix trust snippets
    --manifest <path>            External trust manifest generated by llmix trust manifest.
    --format <format>            json, env, kubernetes, github-actions, terraform, typescript, python, or rust.
    --out <file>                 Write the deployment snippet atomically. Refuses overwrite.
...
Examples:
  ...
  mda llmix trust snippets --manifest llmix-trust.json --format json --out llmix-trust-snippet.json --json
  mda llmix release plan --source authoring --registry-dir registry --policy policy.json --out release-plan.json --json
  mda llmix trust manifest --registry-dir registry --registry-root registry/snapshots/current/registry-root.json --release-plan release-plan.json --policy registry-root-policy.json --derive-root-digest --out llmix-trust.json --json
  mda doctor llmix --source authoring --registry-dir registry --manifest llmix-trust.json --did-document did.json --json
